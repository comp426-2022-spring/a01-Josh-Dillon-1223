...
args["port"] // defines an array named port


// Define a const `port` using the argument from the command line. 
// Make this const default to port 3000 if there is no argument given for `--port`.

const port = args.port || process.env.PORT || 3000 // automatically takes something from environment variables
// if nothing for environment variables are defined, set automatically to 3000
